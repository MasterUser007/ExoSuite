...
plugin_usage_counter = Counter("plugin_usage_total", "Total number of plugin invocations", ["plugin_name"])
plugin_score_histogram = Histogram("plugin_score_distribution", "Score distribution per plugin", ["plugin_name"])
