...
def load_plugins(plugin_folder="ml_plugins", config_file=".ml_config.json"):
    ...
    for plugin_file in plugin_path.glob("*.py"):
        if plugin_file.name in ("__init__.py", "base.py", "loader.py", "plugin_registry.py"):
            continue
        ...
        for attr in dir(module):
            ...
            if isinstance(obj, type) and issubclass(obj, BaseMLPlugin) and obj is not BaseMLPlugin:
                instance = obj()
